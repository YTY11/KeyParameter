...
public class AlarmSystemContr {
    ...
    @RequestMapping("getSMTERROR")//smt
    public   String  AlarmSystemContrSMT(@RequestParam(value = "FloorName",required = true,defaultValue = "D061F") String FloorName,
                                      @RequestParam(value = "LineName",required = true,defaultValue = "") String LineName,
                                      @RequestParam(value = "Product",required = true,defaultValue = "Equipment_SMT")  String Product ,Map map){
    ...
    @RequestMapping("alarmsystemdataSMT")//Tab 异步内容
    public   String  AlarmSystemDataContrSMT(@RequestParam(value = "FloorName",required = true,defaultValue = "D061F") String FloorName,
                                          @RequestParam(value = "LineName",required = true,defaultValue = "") String LineName,
                                          @RequestParam(value = "Product",required = true,defaultValue = "Equipment_SMT")  String Product ,
                                          @RequestParam(value = "MachineType",required = false)  String MachineType ,
                                          @RequestParam(value = "PriorityOrFlg",required = false)  String PriorityOrFlg ,Map map){
        ...
        map.put("StartDate",StartDate);
        map.put("EndDate",EndDate);
        return "SMTERROR :: alarmsystemdata";
    }

    @RequestMapping("alarmsystemtetitledataSMT")//title 异步内容
    public   String  AlarmSystemTitleDataContrSMT(@RequestParam(value = "FloorName",required = true,defaultValue = "D061F") String FloorName,
                                               @RequestParam(value = "LineName",required = true,defaultValue = "") String LineName,
                                               @RequestParam(value = "Product",required = true,defaultValue = "Equipment_SMT")  String Product ,Map map){
        ...
        map.put("StartDate",StartDate);
        map.put("EndDate",EndDate);
        return "SMTERROR :: alarmsystemtitledata";
    }
