...
public class AutoFloor_Rate implements Comparable<AutoFloor_Rate> {
    ...
    private Double  UnconfirmedRate;
    ...
    public Double getUnconfirmedRate() {
        return UnconfirmedRate;
    }

    public void setUnconfirmedRate(Double unconfirmedRate) {
        UnconfirmedRate = unconfirmedRate;
    }
    ...
    @Override
    public int compareTo(AutoFloor_Rate RateUn) {
            if (this.UnconfirmedRate < RateUn.UnconfirmedRate){
                return 1;
            }else if (this.UnconfirmedRate > RateUn.UnconfirmedRate){
                return -1;
            }else {
                return 0;
            }
