...
public class AmountsUPH {
    ...
    //工站编号
    private  String Station_Name_No;
    ...
    public String getStation_Name_No() {
        return Station_Name_No;
    }

    public void setStation_Name_No(String station_Name_No) {
        Station_Name_No = station_Name_No;
    }
