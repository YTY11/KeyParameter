 ...
 */
@Data
public class AutoFloorData implements Comparable<AutoFloorData>{
    ...
    private Integer actualPut;

    private Integer actualPutSum;
    ...
    public Integer getActualPut() {
        return actualPut;
    }

    public void setActualPut(Integer actualPut) {
        this.actualPut = actualPut;
    }

    public Integer getActualPutSum() {
        return actualPutSum;
    }

    public void setActualPutSum(Integer actualPutSum) {
        this.actualPutSum = actualPutSum;
    }
    ...
    public  int compareTo(AutoFloorData NO3List){
